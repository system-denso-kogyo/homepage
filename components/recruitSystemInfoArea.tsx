...
export interface RecruitSystemInfoProps {
...
export const RecruitSystemInfoArea: React.FC<RecruitSystemInfoProps> = ({ recruit, RecruitmentFlow1, RecruitmentFlow2, RecruitmentFlow3, RecruitmentFlow4, Arrow  }) =>
