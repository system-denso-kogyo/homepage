...
import { RecruitInfoProps } from "./recruitEequipmentInfoArea";

const offset = { xs: 0.5, sm: 0.5, md: 0.5, xl: 0, lg: 0.5 }
const offset2 = { xs: 0.01, sm: 0.01, md: 0.01, xl: 0, lg: 0 }

export const RecruitSystemInfoArea: React.FC<RecruitInfoProps> = ({ recruit, RecruitmentFlow1, RecruitmentFlow2, RecruitmentFlow3, RecruitmentFlow4, Arrow }) =>
    <Container fluid css={{ paddingTop: '60px' }}>
        <h1 css={{ textAlign: "center", margin: 0, fontSize: '3rem', color: '#457B9D' }}>システム部採用情報</h1>
        {/* recruit */}
